...
func TestExitCode(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "canceled inside fetch wrapped 2 deep", err: fmt.Errorf("asset: %w", fmt.Errorf("%w: %w", errdefs.ErrFetch, context.Canceled)), want: exitFetch},
		...
		{name: "version not found wrapped 2 deep", err: wrap2(errdefs.ErrVersionNotFound, "pin", "channel"), want: exitFetch},
